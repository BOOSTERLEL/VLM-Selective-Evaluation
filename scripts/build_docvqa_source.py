...
def main() -> None:
    ...
    parser.add_argument("--annotations", required=True, help="DocVQA annotation JSON.")
    parser.add_argument("--image-dir", required=True, help="Directory containing DocVQA images.")
