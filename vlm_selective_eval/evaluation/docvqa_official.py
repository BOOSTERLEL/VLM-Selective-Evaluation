"""DocVQA official-style scoring utilities (ANLS)."""

from __future__ import annotations

from .anls_official_common import (
    anls_score as docvqa_anls_score,
    evaluate_anls_from_predictions,
    evaluate_anls_metrics_with_standard_schema,
)


def evaluate_docvqa_official_from_predictions(rows, threshold: float = 0.5):
...
def evaluate_docvqa_official_metrics_with_standard_schema(rows, n_calibration_bins: int = 10):
